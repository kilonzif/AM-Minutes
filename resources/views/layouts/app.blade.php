...
<head>
    ...
    <title>{{ config('app.name', 'AnalogMinute') }}</title>

    <!-- Scripts -->
    {{--<script src="{{ asset('js/app.js') }}" defer></script>--}}

    <link rel="apple-touch-icon" href="{{asset('images/pied-piper48.png')}}">
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('images/pied-piper48.png')}}">
...
<div id="app">
    ...
    <footer class="footer footer-static footer-light navbar-border fixed-bottom">
        <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
                <span class="float-md-left d-block d-md-inline-block">Copyright © 2020
